...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if limite_excedido:
            ...
            print("Erro na operação! O número máximo de saques foi excedido")
    ...
    def __repr__(self):
        return f"""<{self.__class__.__name__} - Agencia: {self.agencia}, C/C: {self.numero}, Titular: {self.cliente.nome}>"""
...
def main():
    ...
    while True: 
        ...
        if opcao == "d":
            ...
            print("Opção inválida! Insira uma opção válida para sua operação.")
